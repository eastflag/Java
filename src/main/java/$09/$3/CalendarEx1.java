...
class  CalendarEx1 {
	...
	{      // 기본적으로 현재날짜와 시간으로 설정된다.
		...
		//today.add(Calendar.DATE, -7); // 더하기 빼기 연산
		...
		System.out.println(String.format("%d/%02d/%d", today.get(Calendar.YEAR), today.get(Calendar.MONTH)+1, today.get(Calendar.DATE)));
