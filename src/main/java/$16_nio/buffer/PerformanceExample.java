...
public class PerformanceExample {
	public static void main(String[] args) throws Exception {
		Path from = Paths.get("src/main/java/$16_nio/buffer/house.jpg");
		Path to1 = Paths.get("src/main/java/$16_nio/buffer/house2.jpg");
		Path to2 = Paths.get("src/main/java/$16_nio/buffer/house3.jpg");
